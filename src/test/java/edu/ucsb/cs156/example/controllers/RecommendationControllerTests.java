...
public class RecommendationControllerTests extends ControllerTestCase {
        ...
        public void admin_can_edit_an_existing_recommendation() throws Exception {
                ...
                Recommendation recommendationDateOrig = Recommendation.builder()
                                .requesterEmail("studentEmail")
                                .professorEmail("profEmail")
                                .explanation("For grad school")
                                .dateRequested(ldt1)
                ...
                when(recommendationRepository.findById(eq(67L))).thenReturn(Optional.of(recommendationDateOrig));
                ...
                verify(recommendationRepository, times(1)).save(recommendationDateEdited); // should be saved with correct user
                String responseString = response.getResponse().getContentAsString();
